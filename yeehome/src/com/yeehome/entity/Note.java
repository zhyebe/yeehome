...
public class Note implements Serializable {
	...
	public Note(String cn_note_id, String cn_notebook_id, String cn_user_id,
			String cn_note_status_id, String cn_note_type_id,
			String cn_note_title, String cn_note_body,
			long cn_note_create_time, long cn_note_last_modify_time) {
		super();
	...
	public int hashCode() {
		...
		int result = 1;
		result = prime * result
				+ ((cn_note_body == null) ? 0 : cn_note_body.hashCode());
		result = prime * result
				+ (int) (cn_note_create_time ^ (cn_note_create_time >>> 32));
		result = prime * result
				+ ((cn_note_id == null) ? 0 : cn_note_id.hashCode());
		result = prime
				* result
				+ (int) (cn_note_last_modify_time ^ (cn_note_last_modify_time >>> 32));
		result = prime
				* result
				+ ((cn_note_status_id == null) ? 0 : cn_note_status_id
						.hashCode());
		result = prime * result
				+ ((cn_note_title == null) ? 0 : cn_note_title.hashCode());
		result = prime * result
				+ ((cn_note_type_id == null) ? 0 : cn_note_type_id.hashCode());
		result = prime * result
				+ ((cn_notebook_id == null) ? 0 : cn_notebook_id.hashCode());
		result = prime * result
	...
	public boolean equals(Object obj) {
		...
		if (cn_note_body == null) {
			...
			return false;
		if (cn_note_create_time != other.cn_note_create_time)
			return false;
		if (cn_note_id == null) {
			...
			return false;
		if (cn_note_last_modify_time != other.cn_note_last_modify_time)
			return false;
